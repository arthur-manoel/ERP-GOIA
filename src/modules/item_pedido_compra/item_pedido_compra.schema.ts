...
export const createItemPedidoCompraSchema = z.object({
  id_pedido_compra: idSchema,
  id_produto: idSchema,
  quantidade: quantidadeSchema,
  valor_unitario: valorUnitarioSchema,
}).strict()

export const updateItemPedidoCompraSchema = z.object({
...
export const itemPedidoCompraIdSchema = z.object({
  id: z.coerce.number()
    .int('O ID deve ser um número inteiro')
    .positive('O ID deve ser maior que zero'),
})

export const listItemPedidoCompraSchema = z.object({
  ...
  id_pedido_compra: z.coerce.number().int('id_pedido_compra deve ser um número inteiro')
    .positive('id_pedido_compra deve ser maior que zero').optional(),
  id_produto: z.coerce.number().int('id_produto deve ser um número inteiro')
    .positive('id_produto deve ser maior que zero').optional(),
}).strict()

export type CreateItemPedidoCompraInput = z.infer<typeof createItemPedidoCompraSchema>
export type UpdateItemPedidoCompraInput = z.infer<typeof updateItemPedidoCompraSchema>
export type ListItemPedidoCompraInput = z.infer<typeof listItemPedidoCompraSchema>
