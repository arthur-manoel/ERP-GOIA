...
import {
  ...
  NotFoundError,
  ValidationError,
} from './movimentacao_estoque.service.js'

import {
  createMovimentacaoEstoqueSchema,
  listMovimentacaoEstoqueSchema,
  movimentacaoEstoqueIdSchema,
  updateMovimentacaoEstoqueSchema,
...
export class MovimentacaoEstoqueController {
  ...
  private handleError(
    ...
    console.error(
      '[MovimentacaoEstoqueController] Erro inesperado:',
      error
    )
